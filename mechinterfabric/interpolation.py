...
def get_additional_rotation_into_unique_eigensystem(N4_tensor_in_eigen):
    transforms_raw = utils.get_orthotropic_sym_rotations(as_dict=True)
...
def interpolate_N4_decomp_unique_rotation_extended_return_values(N4s, weights):
